    ...
    <div className="container-fluid">
      <div className="landingPage">
        ...
        <div className="banner-text">
          <h1 className="title">
            <span className="title"></span>Not sure where to get the best taste
            of street style ?
          </h1>
          <Link to={'/explore'}>
      ...
      <div className="container-fluid">
        <div className="heading-text">Explore Nearby Food</div>
        <div className="explore-nearby-wrapper">
          ...
          >
            <SwiperSlide>
              {' '}
              <div className="explore-nearby-bg">
                <div>
                  <img
                    className="nearbyFoodImgBurger"
                    src={nearbyFoodImgBurger}
                  ></img>
                </div>
                <div className="explore-nearby-food-name ">
                  BURGER <span style={{ 'font-weight': '600' }}> BOMB</span>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              ...
              <div className="explore-nearby-bg">
                <div>
                  <img
                    className="nearbyFoodImgFries"
                    src={nearbyFoodImgFries}
                  ></img>
                </div>
                <div className="explore-nearby-food-name ">
                  FRIES<span style={{ 'font-weight': '600' }}> FUSION</span>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
